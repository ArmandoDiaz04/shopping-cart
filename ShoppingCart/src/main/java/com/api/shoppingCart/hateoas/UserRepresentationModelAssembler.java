...
import com.api.shoppingCart.controller.CustomerRestController;
...
public class UserRepresentationModelAssembler extends RepresentationModelAssemblerSupport<UserEntity, UserDTO> {
    ...
    public UserDTO toModel(UserEntity entity) {
        ...
        resource.add(
                linkTo(methodOn(CustomerRestController.class).getCustomerById(entity.getUserId().toString()))
                        .withSelfRel());
        resource.add(
                linkTo(methodOn(CustomerRestController.class).getAllCustomers()).withRel("customers"));
        return resource;
    }
